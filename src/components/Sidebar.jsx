  ...
  return (
    <div className='ml-3 h-screen md:overflow-auto overflow-auto md:hover:overflow-auto pb-10'>
      ...
      <div className='flex justify-between items-center'>
        <Link to='/' onClick={handleCloseSidebar()} className='items-center gap-3 ml-3 mt-4 flex text-xl font-extrabold trcking-tight dark:text-white text-slate-900'>
          <SiShopware className='text-3xl'/>
          <span>Slashboard</span>
        </Link>
